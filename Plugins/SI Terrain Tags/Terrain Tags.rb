module GameData
  class TerrainTag
    ...
    attr_reader :ignore_passability
   	attr_reader :can_knockdown
   	attr_reader :can_mine
    ...
    def initialize(hash)
	  ...
	  @can_knockdown          = hash[:can_knockdown]          || false
      @can_dig                = hash[:can_dig]                || false
      @can_hoe                = hash[:can_hoe]                || false
	  @can_mine               = hash[:can_mine]               || false
    end
