...
#===============================================================================
def pbGetSeason 
  return 0 if (pbGetTimeNow.mon==3 && pbGetTimeNow.day>=22) || pbGetTimeNow.mon == 4 || pbGetTimeNow.mon == 5 ||(pbGetTimeNow.mon == 6 && pbGetTimeNow.day <20)#spring
  return 1 if (pbGetTimeNow.mon==6 && pbGetTimeNow.day>=21) || pbGetTimeNow.mon == 7 || pbGetTimeNow.mon == 8 || (pbGetTimeNow.mon == 9 && pbGetTimeNow.day <20) #SUMMER
  return 2 if (pbGetTimeNow.mon==9 && pbGetTimeNow.day>=21) || (pbGetTimeNow.mon == 10 && pbGetTimeNow.day <21)  #Fall
  return 3#winter
end
