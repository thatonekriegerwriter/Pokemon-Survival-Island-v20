...
AdventureGuide.list({
	...
	:sub => [
        ...
        {:name => "Chapter 5: Exploration",  :description => "When venturing far from home, it would not only be a good idea to have a good amount of food and water ready, but portable shelter is also a must for ones ability to comfortably sleep, if you must stay in an area for a long amount of time, however, prioritize locating shelter in the local area."},	
