...
class PokemonTrainerCard_Scene
  ...
  def pbDrawTrainerCardFront
    ...
    textPositions = [
       ...
       [_INTL("{1}%",$Trainer.playerhealth.to_s_formatted),190,103,1,healthColor,shadowColor],
       ...
       [_INTL("{1}%",$Trainer.playerfood.to_s_formatted),190,186,1,hungerColor,shadowColor],
       [_INTL("H20"),34,217,0,baseColor,shadowColor],
       [_INTL(trainerthirst),302,217,1,thirstColor,shadowColor],
       [_INTL("{1}%",$Trainer.playerwater.to_s_formatted),190,217,1,thirstColor,shadowColor],
       [_INTL("SLP"),34,246,0,baseColor,shadowColor],
       [_INTL(trainersleep),302,246,1,sleepColor,shadowColor],
       [_INTL("{1}%",$Trainer.playersleep.to_s_formatted),190,246,1,sleepColor,shadowColor]
    ]
