...
#    level = rand(encounter[2]..encounter[3])
  ...
  if $game_switches[140]==true
    ...
    level= rand(encounter[2]*difficulty)-rand(encounter[3])+pbBalancedLevel($Trainer.party)
    if level < 2
     level = 2 
   end
  else
...
def pbGenerateWildPokemon(species,level,isRoamer=false)
  ...
  genwildpoke.sleep = (rand(50)+1)
  genwildpoke.water = (rand(100)+1)
  genwildpoke.food = (rand(100)+1)
  if genwildpoke.sleep <= 10
  ...
  elsif genwildpoke.sleep <= 20 && genwildpoke.sleep > 10
  ...
  elsif genwildpoke.sleep <= 30 && genwildpoke.sleep > 20
  ...
  elsif genwildpoke.sleep <= 40 && genwildpoke.sleep > 30
