...
[:SUPERPOTION,[:POTION,1,:SITRUSBERRY,2,:QUALOTBERRY,2]],
[:HYPERPOTION,[:SUPERPOTION,1,:SITRUSBERRY,3,:HONDEWBERRY,3]],
[:FULLRESTORE,[:HYPERPOTION,1,:SITRUSBERRY,3,:QUALOTBERRY,5,:GREPABERRY,5,:HONDEWBERRY,5]]
])
end
