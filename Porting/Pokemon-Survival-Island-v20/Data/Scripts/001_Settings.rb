...
module Settings
  ...
  def self.bag_pocket_names
    return [
      ...
      _INTL("Key Items"),
      _INTL("Food"),
      _INTL("Crafting Schematics"),
      _INTL("Tools"),
      _INTL("Crops")
    ]
  end
  # The maximum number of slots per pocket (-1 means infinite number).
  BAG_MAX_POCKET_SIZE  = [30, 20, 20, 20, 20, 20, 20, -1, 20, -1, 20, 20]
  # Whether each pocket in turn auto-sorts itself by item ID number.
  BAG_POCKET_AUTO_SORT = [false, false, false, false, false, false, false, false, false, false, false, false]
