...
class PokemonSystem
  ...
  def initialize
    ...
    @autosave = 1     # Default Autosave Mode (0=on, 1=off)
    @temperature = 1     # Default Temperature Mode (0=on, 1=off)
    @shortmenu = 1     # Default ShortMenu Mode (0=on, 1=off)
  ...
  def pbStartScene(inloadscreen=false)
    ...
    @PokemonOptions = [
       ...
       EnumOption.new(_INTL("Survival Mode"),[_INTL("On"),_INTL("Off")],
          proc { $PokemonSystem.survivalmode },
          proc {|value|  $PokemonSystem.survivalmode = value }
       ),
       EnumOption.new(_INTL("Nuzlocke Mode"),[_INTL("On"),_INTL("Off")],
          proc { $PokemonSystem.nuzlockemode },
          proc {|value|  $PokemonSystem.nuzlockemode = value }
       ),
       EnumOption.new(_INTL("Autobackup"),[_INTL("On"),_INTL("Off")],
          proc { $PokemonSystem.autosave },
          proc {|value|  $PokemonSystem.autosave = value }
       ),
       EnumOption.new(_INTL("Temperature System"),[_INTL("On"),_INTL("Off")],
          proc { $PokemonSystem.temperature },
          proc {|value|  $PokemonSystem.temperature = value }
       ),
       EnumOption.new(_INTL("HUD"),[_INTL("On"),_INTL("Off")],
          proc { $PokemonSystem.shortmenu },
          proc {|value|  $PokemonSystem.shortmenu = value }
       ),
