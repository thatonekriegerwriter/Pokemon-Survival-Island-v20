...
module Settings
  ...
  # the first number (0).
  BAG_MAX_POCKET_SIZE  = [0, 30, 20, 20, 20, 20, 20, 20, -1, 20]
  # The maximum number of items each slot in the Bag can hold.
  BAG_MAX_PER_SLOT     = 99
  # Whether each pocket in turn auto-sorts itself by item ID number. Ignore the
  # first entry (the 0).
  BAG_POCKET_AUTO_SORT = [0, false, false, false, false, false, false, false, false, false]
