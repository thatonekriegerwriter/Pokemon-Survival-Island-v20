...
def pbStartOver(gameover=false)
  if pbInBugContest?
    pbBugContestStartO6ver
    return
  end             
  $Trainer.party[0].changeHappiness("TrainerPassedOut",$Trainer.party[0])
  $Trainer.party[0].changeLoyalty("TrainerPassedOut",$Trainer.party[0])
  $Trainer.party[1].changeHappiness("TrainerPassedOut",$Trainer.party[1])
  $Trainer.party[1].changeLoyalty("TrainerPassedOut",$Trainer.party[1])
  $Trainer.party[2].changeHappiness("TrainerPassedOut",$Trainer.party[2])
  $Trainer.party[2].changeLoyalty("TrainerPassedOut",$Trainer.party[2])
  $Trainer.party[3].changeHappiness("TrainerPassedOut",$Trainer.party[3])
  $Trainer.party[3].changeLoyalty("TrainerPassedOut",$Trainer.party[3])
  $Trainer.party[4].changeHappiness("TrainerPassedOut",$Trainer.party[4])
  $Trainer.party[4].changeLoyalty("TrainerPassedOut",$Trainer.party[4])
  $Trainer.party[5].changeHappiness("TrainerPassedOut",$Trainer.party[5])
  $Trainer.party[5].changeLoyalty("TrainerPassedOut",$Trainer.party[5])
  $Trainer.heal_party
