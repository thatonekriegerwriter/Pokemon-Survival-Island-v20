...
[:POWERLENS,[:GLASS,2,:IRON2,0.5]]
		...
		if wari == :APRICORNCRAFTING
		  if cmd==0
pbItemCrafter([
[:POKEBALL,[:REDAPRICORN,1,:TUMBLEROCK,1]],
[:GREATBALL,[:REDAPRICORN,2,:BLUEAPRICORN,1,:TUMBLEROCK,1]],
[:ULTRABALL,[:BLACKAPRICORN,2,:YELLOWAPRICORN,1,:REDAPRICORN,1,:TUMBLEROCK,1]],
[:SUPERBALL,[:WHITEAPRICORN,4,:GREENAPRICORN,1,:YELLOWAPRICORN,2,:TUMBLEROCK,1]],
[:PREMIERBALL,[:WHITEAPRICORN,1,:POKEBALL,1]]
])
		 elsif cmd==1
		 pbItemCrafter([
[:LUREBALL,[:REDAPRICORN,1,:BLUEAPRICORN,2,:TUMBLEROCK,1]],
[:LEVELBALL,[:BLACKAPRICORN,2,:REDAPRICORN,1,:TUMBLEROCK,1]],
[:HEAVYBALL,[:BLUEAPRICORN,2,:TUMBLEROCK,1]],
[:LOVEBALL,[:WHITEAPRICORN,2,:TUMBLEROCK,1]],
[:SPORTBALL,[:REDAPRICORN,2,:WHITEAPRICORN,1,:TUMBLEROCK,1]],
[:SAFARIBALL,[:GREENAPRICORN,2,:YELLOWAPRICORN,1,:TUMBLEROCK,1]],
[:FRIENDBALL,[:GREENAPRICORN,2,:WHITEAPRICORN,1,:TUMBLEROCK,1]]
])
		 elsif cmd==2
		 pbItemCrafter([
[:NESTBALL,[:GREENAPRICORN,2,:YELLOWAPRICORN,1,:TANGABERRY,1,:TUMBLEROCK,1]],
[:REPEATBALL,[:REDAPRICORN,1,:BLACKAPRICORN,2,:JABOCABERRY,3,:TUMBLEROCK,1]],
[:LUXURYBALL,[:REDAPRICORN,1,:WHITEAPRICORN,2,:TUMBLEROCK,1]],
[:DIVEBALL,[:PINKAPRICORN,1,:BLUEAPRICORN,2,:PASSHOBERRY,2,:TUMBLEROCK,1]],
[:TIMERBALL,[:WHITEAPRICORN,2,:BLACKAPRICORN,1,:DURINBERRY,2,:TUMBLEROCK,1]]
])
		 elsif cmd==3
		 pbItemCrafter([
[:DUSKBALL,[:BLACKAPRICORN,2,:BLUEAPRICORN,1,:BLUKBERRY,2,:TUMBLEROCK,1]],
[:HEALBALL,[:PINKAPRICORN,1,:WHITEAPRICORN,2,:ORANBERRY,5,:TUMBLEROCK,1]],
[:QUICKBALL,[:YELLOWAPRICORN,1,:BLUEAPRICORN,2,:CUSTAPBERRY,2,:TUMBLEROCK,1]],
[:CHERISHBALL,[:REDAPRICORN,1,:POKEBALL,2,:TUMBLEROCK,1]]
])
		 elsif cmd==4
		 pbItemCrafter([
[:NETBALL,[:BLACKAPRICORN,1,:WHITEAPRICORN,2,:TUMBLEROCK,1]],
[:SHOCKBALL,[:YELLOWAPRICORN,3,:WHITEAPRICORN,2,:TUMBLEROCK,1]],
[:MOONBALL,[:YELLOWAPRICORN,2,:BLACKAPRICORN,1,:TUMBLEROCK,1]]
])
		 elsif cmd==5
		 pbItemCrafter([
[:STATUSBALL,[:WHITEAPRICORN,2,:REDAPRICORN,5,:PECHABERRY,4,:TUMBLEROCK,1]],
[:BURNBALL,[:REDAPRICORN,3,:GREENAPRICORN,1,:RAWSTBERRY,4,:TUMBLEROCK,1]],
[:DREAMBALL,[:BLACKAPRICORN,1,:PINKAPRICORN,3,:CHESTOBERRY,4,:TUMBLEROCK,1]],
[:FREEZEBALL,[:BLUEAPRICORN,3,:WHITEAPRICORN,3,:ASPEARBERRY,4,:TUMBLEROCK,1]],
[:STUNBALL,[:YELLOWAPRICORN,2,:PINKAPRICORN,3,:CHERIBERRY,4,:TUMBLEROCK,1]],
[:TOXICBALL,[:BLACKAPRICORN,3,:GREENAPRICORN,2,:PECHABERRY,4,:TUMBLEROCK,1]]
])
		 elsif cmd==6
		 pbItemCrafter([
[:BARBEDBALL,[:GREENAPRICORN,2,:BLACKAPRICORN,2,:IRON2,1,:TUMBLEROCK,1]],
[:YOLOBALL,[:REDAPRICORN,4,:PINKAPRICORN,1,:SHUCABERRY,1,:TUMBLEROCK,1]],
[:STATUSBALL,[:BLACKAPRICORN,2,:PINKAPRICORN,3,:STARFBERRY,1,:TUMBLEROCK,1]],
[:HIDDENBALL,[:PINKAPRICORN,8,:GREENAPRICORN,8,:CUSTAPBERRY,5,:TUMBLEROCK,1]],
[:IMMUNEBALL,[:BLACKAPRICORN,1,:WHITEAPRICORN,3,:CHILANBERRY,2,:TUMBLEROCK,1]],
[:DEBUFFBALL,[:REDAPRICORN,1,:BLACKAPRICORN,3,:YELLOWAPRICORN,3,:TUMBLEROCK,1]],
[:DAWNBALL,[:WHITEAPRICORN,1,:YELLOWAPRICORN,1,:TUMBLEROCK,1]]
])
...
[:ULTRABALL,[:BLACKAPRICORN,2,:YELLOWAPRICORN,1,:REDAPRICORN,1,:TUMBLEROCK,1]],
[:SUPERBALL,[:WHITEAPRICORN,4,:GREENAPRICORN,1,:YELLOWAPRICORN,2,:TUMBLEROCK,1]],
[:PREMIERBALL,[:WHITEAPRICORN,1,:POKEBALL,1,:TUMBLEROCK,1]],
[:MASTERBALL,[:PURPLEAPRICORN,2,:ENIGMABERRY,2,:COMETSHARD,1,:TUMBLEROCK,1]]
])
		 elsif cmd==1
		 pbItemCrafter([
[:LUREBALL,[:REDAPRICORN,0.5,:BLUEAPRICORN,1,:TUMBLEROCK,1]],
[:LEVELBALL,[:BLACKAPRICORN,1,:REDAPRICORN,0.5,:TUMBLEROCK,1]],
[:HEAVYBALL,[:BLUEAPRICORN,1,:TUMBLEROCK,1]],
[:LOVEBALL,[:WHITEAPRICORN,1,:TUMBLEROCK,1]],
[:SPORTBALL,[:REDAPRICORN,1,:WHITEAPRICORN,0.5,:TUMBLEROCK,1]],
[:SAFARIBALL,[:GREENAPRICORN,1,:YELLOWAPRICORN,0.5,:TUMBLEROCK,1]],
[:FRIENDBALL,[:GREENAPRICORN,1,:WHITEAPRICORN,0.5,:TUMBLEROCK,1]]
])
		 elsif cmd==2
		 pbItemCrafter([
[:NESTBALL,[:GREENAPRICORN,1,:YELLOWAPRICORN,0.5,:TANGABERRY,0.5,:TUMBLEROCK,1]],
[:REPEATBALL,[:REDAPRICORN,0.5,:BLACKAPRICORN,1,:JABOCABERRY,1.5,:TUMBLEROCK,1]],
[:LUXURYBALL,[:REDAPRICORN,0.5,:WHITEAPRICORN,1,:TUMBLEROCK,1]],
[:DIVEBALL,[:PINKAPRICORN,0.5,:BLUEAPRICORN,1,:PASSHOBERRY,1,:TUMBLEROCK,1]],
[:TIMERBALL,[:WHITEAPRICORN,1,:BLACKAPRICORN,0.5,:DURINBERRY,1,:TUMBLEROCK,1]]
])
		 elsif cmd==3
		 pbItemCrafter([
[:DUSKBALL,[:BLACKAPRICORN,1,:BLUEAPRICORN,0.5,:BLUKBERRY,1,:TUMBLEROCK,1]],
[:HEALBALL,[:PINKAPRICORN,0.5,:WHITEAPRICORN,1,:ORANBERRY,2.5,:TUMBLEROCK,1]],
[:QUICKBALL,[:YELLOWAPRICORN,0.5,:BLUEAPRICORN,1,:CUSTAPBERRY,1,:TUMBLEROCK,1]],
[:CHERISHBALL,[:REDAPRICORN,0.5,:POKEBALL,1,:TUMBLEROCK,1]]
])
		 elsif cmd==4
		 pbItemCrafter([
[:NETBALL,[:BLACKAPRICORN,0.5,:WHITEAPRICORN,1,:TUMBLEROCK,1]],
[:SHOCKBALL,[:YELLOWAPRICORN,1.5,:WHITEAPRICORN,1,:TUMBLEROCK,1]],
[:MOONBALL,[:YELLOWAPRICORN,1,:BLACKAPRICORN,0.5,:TUMBLEROCK,1]]
])
		 elsif cmd==5
		 pbItemCrafter([
[:STATUSBALL,[:WHITEAPRICORN,1,:REDAPRICORN,2.5,:PECHABERRY,2,:TUMBLEROCK,1]],
[:BURNBALL,[:REDAPRICORN,1.5,:GREENAPRICORN,0.5,:RAWSTBERRY,2,:TUMBLEROCK,1]],
[:DREAMBALL,[:BLACKAPRICORN,0.5,:PINKAPRICORN,1.5,:CHESTOBERRY,2,:TUMBLEROCK,1]],
[:FREEZEBALL,[:BLUEAPRICORN,1.5,:WHITEAPRICORN,1.5,:ASPEARBERRY,2,:TUMBLEROCK,1]],
[:STUNBALL,[:YELLOWAPRICORN,1,:PINKAPRICORN,1.5,:CHERIBERRY,2,:TUMBLEROCK,1]],
[:TOXICBALL,[:BLACKAPRICORN,1.5,:GREENAPRICORN,1,:PECHABERRY,2,:TUMBLEROCK,1]]
])
		 elsif cmd==6
		 pbItemCrafter([
[:BARBEDBALL,[:GREENAPRICORN,1,:BLACKAPRICORN,1,:IRON2,0.5,:TUMBLEROCK,1]],
[:YOLOBALL,[:REDAPRICORN,2,:PINKAPRICORN,0.5,:SHUCABERRY,0.5,:TUMBLEROCK,1]],
[:STATUSBALL,[:BLACKAPRICORN,1,:PINKAPRICORN,1.5,:STARFBERRY,0.5,:TUMBLEROCK,1]],
[:HIDDENBALL,[:PINKAPRICORN,4,:GREENAPRICORN,4,:CUSTAPBERRY,2.5,:TUMBLEROCK,1]],
[:IMMUNEBALL,[:BLACKAPRICORN,0.5,:WHITEAPRICORN,1.5,:CHILANBERRY,1,:TUMBLEROCK,1]],
[:DEBUFFBALL,[:REDAPRICORN,0.5,:BLACKAPRICORN,1.5,:YELLOWAPRICORN,1.5,:TUMBLEROCK,1]],
[:DAWNBALL,[:WHITEAPRICORN,0.5,:YELLOWAPRICORN,0.5,:TUMBLEROCK,1]]
])
end
end
end
