...
class PokemonSummary_Scene
  ...
  def drawSelectedMove(move_to_learn, selected_move)
    ...
    #---------------------------------------------------------------------------
    # ZUD - Display Max Move description.
    #---------------------------------------------------------------------------
...
=end
    ...
    textpos = [
       ...
       [_INTL("Happiness:"),textColumn,234,62,base,statshadows[4]],
       [_INTL("{1}/250",@pokemon.happiness{1}),textColumn,270,79,base,statshadows[2]],
    ]
...
###---EDIT END---###
  ...
  def pbGoToPrevious
    ...
    while newindex>0
      newindex -= 1
      if @party[newindex] && (@page==1 || !@party[newindex].egg? || (@page==6 && SHOWFAMILYEGG))
        @partyindex = newindex
        break
      end
    end
