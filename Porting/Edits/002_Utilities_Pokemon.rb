...
def pbAddPokemon(pkmn, level = 1, see_form = true)
  ...
  if pkmn.sleep <= 10
    ...
    pkmn.ev[:HP] = rand(40)
  elsif pkmn.sleep <= 20 && pkmn.sleep > 10
    ...
    pkmn.ev[:HP] = rand(80)
  elsif pkmn.sleep <= 30 && pkmn.sleep > 20
    pkmn.ev[:DEFENSE] = rand(120)
    genwildpoke.ev[:SPECIAL_DEFENSE] = rand(120)
    pkmn.ev[:ATTACK] = rand(120)
    pkmn.ev[:SPECIAL_ATTACK] = rand(120)
    pkmn.ev[:SPEED] = rand(120)
    pkmn.ev[:HP] = rand(120)
  elsif pkmn.sleep <= 40 && pkmn.sleep > 30
    ...
    pkmn.ev[:HP] = rand(150)
  elsif pkmn.sleep <= 51 && pkmn.sleep > 40
