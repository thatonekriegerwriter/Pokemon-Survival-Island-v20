...
def refresh_extended_hud_display
     ...
     @sprites2["extendedBG"].setBitmap("Graphics/UI/OV HUD/extendedbg") if $PokemonGlobal.cur_stored_pokemon.nil? && $PokemonGlobal.alt_control_move==false && @sprites2["extendedBG"].name!="Graphics/UI/OV HUD/extendedbg"
     @sprites2["extendedBG"].setBitmap("Graphics/UI/OV HUD/extendedbg2") if (!$PokemonGlobal.cur_stored_pokemon.nil? || $PokemonGlobal.alt_control_move==true) && @sprites2["extendedBG"].name!="Graphics/UI/OV HUD/extendedbg2"
     @sprites2["extendedBG"].visible=true if @sprites2["extendedBG"].visible==false
