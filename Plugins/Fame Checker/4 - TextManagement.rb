module FameChecker
  class FC
    ...
    def messageDisplay(msgwindow, message, letterbyletter=true, endOnUse = true, endOnBack = true, commandProc=nil)
      ...
      text.gsub!(/\\pa1/i,_INTL("Affinity: {1}",$player.partner1affinity)) if 
      text.gsub!(/\\pa2/i,_INTL("Affinity: {1}",$player.partner2affinity))
      text.gsub!(/\\pa3/i,_INTL("Affinity: {1}",$player.partner3affinity))
      text.gsub!(/\\pa4/i,_INTL("Affinity: {1}",$player.partner4affinity))
      text.gsub!(/\\pa5/i,_INTL("Affinity: {1}",$player.partner5affinity))
      text.gsub!(/\\pa6/i,_INTL("Affinity: {1}",$player.partner6affinity))
      text.gsub!(/\\pa7/i,_INTL("Affinity: {1}",$player.partner7affinity))
      text.gsub!(/\\pa8/i,_INTL("Affinity: {1}",$player.partner8affinity))
      text.gsub!(/\\pab/i,_INTL("Affinity: {1}",$player.blueaffinity))
      text.gsub!(/\\par/i,_INTL("Affinity: {1}",$player.redaffinity))
      text.gsub!(/\\n/i,"\n")
