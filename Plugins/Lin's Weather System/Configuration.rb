...
#===============================================================================
  ...
  # NOTE: these entries are matched by zone position, in the same order zones are
  # registered in 005_Zones.rb (index 0 = the 1st registered zone, and so on).
  WEATHER_SUBSTITUTE = [
...
# * Zones Configuration
#===============================================================================
  # Zone -> map lists and each zone's per-season weather probabilities now live on
  # GameData::Zone (see 005_Zones.rb) instead of here. See GameData::Zone.all,
  # GameData::Zone#maps and GameData::Zone#weather(season).
...
#===============================================================================
  ...
  # In Map ID you have to put the ID of the map the name corresponds to, like in ZONE_MAPS.
    #{"Map Name" => Map ID},
  # NOTE: like WEATHER_SUBSTITUTE above, these entries are matched by zone position
  # in GameData::Zone.all's registration order.
  MAPS_POSITIONS = [
