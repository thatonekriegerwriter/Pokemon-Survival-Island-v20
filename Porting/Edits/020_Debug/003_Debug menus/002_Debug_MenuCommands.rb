...
DebugMenuCommands.register("sethp", {
  "parent"      => "playermenu",
  "name"        => _INTL("Set Player Health"),
  "description" => _INTL("Edit your health."),
  "effect"      => proc {
    params = ChooseNumberParams.new
    params.setRange(0, 100)
    params.setDefaultValue($Trainer.playerhealth)
    $Trainer.playerhealth = pbMessageChooseNumber(_INTL("Set the player's HP amount."), params)
    pbMessage(_INTL("You now have {1} HP.", $Trainer.playerhealth.to_s_formatted))
  }
})

DebugMenuCommands.register("setSleep", {
  "parent"      => "playermenu",
  "name"        => _INTL("Set Player Sleep"),
  "description" => _INTL("Edit your sleep."),
  "effect"      => proc {
    params = ChooseNumberParams.new
    params.setRange(0, 200)
    params.setDefaultValue($Trainer.playersleep)
    $Trainer.playersleep = pbMessageChooseNumber(_INTL("Set the player's sleep amount."), params)
    pbMessage(_INTL("You now have {1} Sleep.", $Trainer.playersleep.to_s_formatted))
  }
})

DebugMenuCommands.register("setFood", {
  "parent"      => "playermenu",
  "name"        => _INTL("Set Player Food"),
  "description" => _INTL("Edit your food."),
  "effect"      => proc {
    params = ChooseNumberParams.new
    params.setRange(0, 100)
    params.setDefaultValue($Trainer.playersleep)
...
DebugMenuCommands.register("setWater", {
  "parent"      => "playermenu",
  "name"        => _INTL("Set Player Water"),
  "description" => _INTL("Edit your Water."),
  "effect"      => proc {
    params = ChooseNumberParams.new
    params.setRange(0, 100)
    params.setDefaultValue($Trainer.playerwater)
    $Trainer.playerwater = pbMessageChooseNumber(_INTL("Set the player's water amount."), params)
    pbMessage(_INTL("You now have {1} water.", $Trainer.playerwater.to_s_formatted))
  }
})

DebugMenuCommands.register("setSaturation", {
  "parent"      => "playermenu",
  "name"        => _INTL("Set Player Saturation"),
  "description" => _INTL("Edit your saturation."),
  "effect"      => proc {
    params = ChooseNumberParams.new
    params.setRange(0, 200)
    params.setDefaultValue($Trainer.playerfood)
    $Trainer.playerfood = pbMessageChooseNumber(_INTL("Set the player's saturation amount."), params)
    pbMessage(_INTL("You now have {1} saturation.", $Trainer.playerfood.to_s_formatted))
  }
})

DebugMenuCommands.register("setStamina", {
  "parent"      => "playermenu",
  "name"        => _INTL("Set Player Stamina"),
  "description" => _INTL("Edit your Stamina."),
  "effect"      => proc {
    params = ChooseNumberParams.new
    params.setRange(0, 100)
    params.setDefaultValue($Trainer.playerstamina)
    $Trainer.playerstamina = pbMessageChooseNumber(_INTL("Set the player's saturation amount."), params)
    pbMessage(_INTL("You now have {1} saturation.", $Trainer.playerstamina.to_s_formatted))
  }
})
