...
#pbFadeOutIn {
  ...
  Crafts.craftWindow(:APRICORNCRAFTING ,4, data) if wari == :APRICORNCRAFTING || wari == :APRICORNMACHINE #COMPLETE
  Crafts.craftWindow(:MEDICINEPOT ,5, data) if wari == :MEDICINEPOT #GOOD ENOUGH TO USE THE CRAFTING BENCH UI.
  Crafts.craftWindow(:UPGRADEDCRAFTINGBENCH ,5, data) if wari == :UPGRADEDCRAFTINGBENCH #COMPLETE
#  }
end
