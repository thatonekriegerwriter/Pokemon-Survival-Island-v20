...
module CraftsList
  def self.getcrafts
    ...
    [:SUSPO,:ARGOSTBERRY,:ENIGMABERRY,:FRESHWATER],
    [:SUSPO,:ENIGMABERRY,:ARGOSTBERRY,:FRESHWATER],
    [:SUSPO,:ARGOSTBERRY,:ENIGMABERRY,:FRESHWATER],
    [:SUSPO,:FRESHWATER,:ARGOSTBERRY,:ENIGMABERRY],
    [:SUSPO,:FRESHWATER,:ENIGMABERRY,:ARGOSTBERRY],
	#RECIPE 37:
