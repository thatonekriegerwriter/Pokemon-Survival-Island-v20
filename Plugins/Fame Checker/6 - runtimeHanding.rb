  ...
  class FC
    ...
    def listRun()
      ...
      loop do
        ...
        messageOutput = self.messageDisplay(msgBox, currFame != "CANCEL" ? "" : "The Fame Checker will be closed. Cya!", true, false, false){
    ...
    def deviceRun()
      ...
      loop do
        if !deviceMoving
          ...
          msgBox = pbCreateMessageWindow(nil, nil)
          messageOutput = self.messageDisplay(msgBox, currFame != "CANCEL" ? currFame.upcase : "The Fame Checker will be closed. Cya!", true, false, false){
            pbUpdateSpriteHash(@sprites)
