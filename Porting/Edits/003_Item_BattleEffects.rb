...
ItemHandlers::BattleUseOnPokemon.add(:SITRUSBERRY,proc { |item,pokemon,battler,choices,scene|
  pbBattleHPItem(pokemon,battler,pokemon.totalhp/5,scene)
})
...
ItemHandlers::BattleUseOnPokemon.add(:ENERGYPOWDER,proc { |item,pokemon,battler,choices,scene|
  if pbBattleHPItem(pokemon,battler,50,scene)
    pokemon.changeHappiness("powder",battler)
    pokemon.changeLoyalty("powder",battler)
  end
})
...
ItemHandlers::BattleUseOnPokemon.add(:ENERGYROOT,proc { |item,pokemon,battler,choices,scene|
  if pbBattleHPItem(pokemon,battler,200,scene)
    pokemon.changeHappiness("energyroot",battler)
    pokemon.changeLoyalty("energyroot",battler)
  end
})
...
ItemHandlers::BattleUseOnPokemon.add(:REVIVALHERB,proc { |item,pokemon,battler,choices,scene|
  pokemon.heal_HP
  pokemon.heal_status
  pokemon.changeHappiness("revivalherb",battler)
  pokemon.changeLoyalty("revivalherb",battler)
  scene.pbRefresh
  scene.pbDisplay(_INTL("{1} recovered from fainting!",pokemon.name))
})
...
ItemHandlers::BattleUseOnBattler.add(:ATKCURRY,proc { |item,battler,scene|
  battler.pbRaiseStatStage(:ATTACK,3,battler)
  battler.pokemon.changeHappiness("battleitem",battler)
  battler.pokemon.changeLoyalty("battleitem",battler)
})
...
ItemHandlers::BattleUseOnBattler.add(:DEFCURRY,proc { |item,battler,scene|
  battler.pbRaiseStatStage(:DEFENSE,3,battler)
  battler.pokemon.changeHappiness("battleitem",battler)
  battler.pokemon.changeLoyalty("battleitem",battler)
})
...
ItemHandlers::BattleUseOnBattler.add(:SATKCURRY,proc { |item,battler,scene|
  battler.pbRaiseStatStage(:SPECIAL_ATTACK,3,battler)
  battler.pokemon.changeHappiness("battleitem",battler)
  battler.pokemon.changeLoyalty("battleitem",battler)
})
...
ItemHandlers::BattleUseOnBattler.add(:SPDEFCURRY,proc { |item,battler,scene|
  battler.pbRaiseStatStage(:SPECIAL_DEFENSE,3,battler)
  battler.pokemon.changeHappiness("battleitem",battler)
  battler.pokemon.changeLoyalty("battleitem",battler)
})
...
ItemHandlers::BattleUseOnBattler.add(:SPEEDCURRY,proc { |item,battler,scene|
  battler.pbRaiseStatStage(:SPEED,3,battler)
  battler.pokemon.changeHappiness("battleitem",battler)
  battler.pokemon.changeLoyalty("battleitem",battler)
})
...
ItemHandlers::BattleUseOnBattler.add(:ACCCURRY,proc { |item,battler,scene|
  battler.pbRaiseStatStage(:ACCURACY,3,battler)
  battler.pokemon.changeHappiness("battleitem",battler)
  battler.pokemon.changeLoyalty("battleitem",battler)
})
