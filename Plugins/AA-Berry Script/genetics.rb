...
module BerryGenetics
  ...
  SPECIES_DOMINANT = [
  :ABSORBBULB, :AGUAVBERRY, :ASPEARBERRY, :BABIRIBERRY, :BIGROOT, :BLUKBERRY,
  :CARROT, :CHARTIBERRY, :CHERIBERRY, :CHESTOBERRY, :CHILANBERRY, :CHOPLEBERRY,
  :COBABERRY, :COCOABEAN, :COLBURBERRY, :ELECTRICSEED, :ENERGYROOT, :FIGYBERRY,
  :GRASSYSEED, :HABANBERRY, :IAPAPABERRY, :KASIBBERRY, :KEBIABERRY, :LEEK,
  :LEPPABERRY, :LUMBERRY, :LUMINOUSMOSS, :MAGOBERRY, :MENTALHERB, :MISTYSEED,
  :NANABBERRY, :OCCABERRY, :ONION, :PASSHOBERRY, :PAYAPABERRY, :PECHABERRY,
  :PERSIMBERRY, :PINAPBERRY, :PINKAPRICORN, :POTATO, :POWERHERB, :PSYCHICSEED,
  :RAWSTBERRY, :RAZZBERRY, :RINDOBERRY, :ROSELIBERRY, :SHUCABERRY, :SUGARCANE,
  :TANGABERRY, :TEALEAF, :TINYMUSHROOM, :TROPIUSFRUIT, :WACANBERRY, :WEPEARBERRY,
  :WHEAT, :WHITEAPRICORN, :WHITEHERB, :WIKIBERRY, :YACHEBERRY, :YELLOWAPRICORN,
].freeze
  ...
  CLIMATE_DOMINANT      = ["Temperate", "Plain", "Forest"].freeze  # PLACEHOLDER
  WEATHER_DOMINANT      = [:None].freeze  # PLACEHOLDER
