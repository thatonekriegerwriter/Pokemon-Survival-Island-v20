...
module VisibleEncounterSettings
  ...
  MAX_ENCOUNTER_REDUCED = 2 # default 8 - means that at most 8 pokemon will have a drastically reduced spawn probability before it become the usual encounter probability
